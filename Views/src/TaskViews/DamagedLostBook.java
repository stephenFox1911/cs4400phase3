    ...
    public DamagedLostBook(UserView in) {
        ...
        btnSubmit.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	assessPenalty(penaltyUsername,Float.parseFloat(txtChargeammount.getText()),textISBN.getText(),txtCopynumber.getText());
        ...
        btnLookForLastUser.addActionListener(new ActionListener() {
            public void actionPerformed(ActionEvent e) {
            	penaltyUsername = getPreviousUser(textISBN.getText(),txtCopynumber.getText());
            }
        });
